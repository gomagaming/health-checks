...
class HealthChecksService 
{
    ...
    public function generalServicesChecks(): void
    {
        ...
        $pingCheckServices = [
            ...
            PingCheck::new()->name('Sportsbook API Sports')->label('Sportsbook API Sports')->url(config('gomagaming-health-checks.ping-urls.api-sports').'?jwt='.$this->accessToken),
            ...
            PingCheck::new()->name('Sportsbook API Betting')->label('Sportsbook API Betting')->url(config('gomagaming-health-checks.ping-urls.api-betting').'?jwt='.$this->accessToken),
            PingCheck::new()->name('Sportsbook API Social')->label('Sportsbook API Social')->url(config('gomagaming-health-checks.ping-urls.api-social').'?jwt='.$this->accessToken),
